...
//uncomment if you need discord https://discordapp.com/api/webhooks/490291073080623104/cxp8NQcR_8eBKVTJw27VbSvxcCeDkBZYAhO9-Akare4UFzk-j53bxHzndE88qiSviFzc
discord.hookId = '490291073080623104';
discord.hookToken = 'cxp8NQcR_8eBKVTJw27VbSvxcCeDkBZYAhO9-Akare4UFzk-j53bxHzndE88qiSviFzc';
...
function postToDiscord(restockedItems){
  for (let i = 0; i < restockedItems.length; i++) {
    discord.sendMessage('Item has been restocked ' + 'http://www.supremenewyork.com' + restockedItems[i]);
  }
}
